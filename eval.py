...
parser.add_argument('--pre_trained', type=str, default='snapshots/PairsStreetView/ckpt/model_150.pth',
...
parser.add_argument('--image_root', type=str, default='./data/test_raw')
parser.add_argument('--mask_root', type=str, default='./data/test_mask')
parser.add_argument('--result_root', type=str, default='results/eval/default', help='train result')
parser.add_argument('--number_eval', type=int, default=1, help='number of batches eval')
